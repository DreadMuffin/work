...
def ct34():
    print get(0)
    returnstring = ""
    croutine = "\n\\section{" + get(4) + "}\n\\subsection{Routine}\n" + "\\item Eff. mAs: " + get(11) + "\\item kV: " + get(19)[:-4] + "\\item CARE Dose4D: " + get(8)[2:] + "\\item CTDlvol: " + get(10) + "mGy\\item Scan time: " + get(5) + " s\\item Delay: " + get(6) + " s\\item Slice: " + get(15) + " mm\\item No. of images: " + "Samme som i foerste recon, slet?(y/n)" + "\\item Tilt: " + get(18) + " grader"

    cscan =  "\n\\subsection{Scan}\n\\item Quality ref. mAs: " + get(7) + "\\item Eff. mAs: " + get(11) + "\\item kV: " + get(19)[:-4] + "\\item Scan time: " + get(5) + " s\\item Rotation time: " + get(14) + " s\\item Delay: " + get(6) + " s\\item Slice: " +  get(15) + " mm\\item Pitch: " + get(13) + "\\item Direction: " + get(16)[2:]
