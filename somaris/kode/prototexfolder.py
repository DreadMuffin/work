...
for file in listing:
    ...
    while j < Precons:
        Precon +="\n\\subsubsection{Recon " + str(j + 1) + "}" + "\n\\item Series description: " + PF(94)[1:-1] + "\n\\item Recon range (bed): ups.." + "\n\\item Output image type: " + PF(84)[2:] + "\n\\item Recon method: " + PF(85)[2:] + "\n\\item Iterations: " + PF(88) + "\n\\item Subsets: " + PF(87) + "\n\\item Image size: " + PF(86) + "\n\\item Zoom: " + PF(89) + "\n\\item Filter: " + PF(92)[2:] + "\n\\item FWHM (mm): " + PF(90) + "\n\\item Offset X (mm): " + PF(95) + "\n\\item Offset Y (mm): " + PF(96) + "\n\\item Attenuation correction: " + PF(83) + "\n\\item Scatter correction: " + PF(91) + "\n\\item Match CT slice location: " + PF(93) + "\n\\item Save intermediate data: " + PF(97)
        j+=1
    j-=1
