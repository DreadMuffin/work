...
\title{6\_PETCT\_Body\_LM.MlAdult}
...
\section{CT Body}
\subsection{Routine}
\item Eff. mAs: 170\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 11.4779mGy\item Scan time: 5.630 s\item Delay: 4.000 s\item Slice: 5.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 170 grader
\subsection{Scan}
