...
\title{PETCT\_AC\_Brain.Adult\_PET4}
...
\section{CT Brain}
\subsection{Routine}
\item Eff. mAs: 170\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 29.597mGy\item Scan time: 20.050 s\item Delay: 2.000 s\item Slice: 3 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 350\item Eff. mAs: 170\item kV: 120\item Scan time: 20.050 s\item Rotation time: 1.000 s\item Delay: 2.000 s\item Slice: 3 mm\item Pitch: 1.00\item Direction: Caudocranial\subsection{Recons}
