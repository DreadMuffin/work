...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 60\item kV: 9\item CARE Dose4D: On\item CTDlvol: 4.04601mGy\item Scan time: 1.4000000 s\item Delay: 20.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 60 grader
\subsection{Scan}
\item Quality ref. mAs: 60\item Eff. mAs: 60\item kV: 120\item Scan time: 9.140 s\item Rotation time: 0.500 s\item Delay: 20.000 s\item Slice: 0.6 mm\item Pitch: 1.4000000\item Direction: Craniocaudal
\subsection{Recon}
