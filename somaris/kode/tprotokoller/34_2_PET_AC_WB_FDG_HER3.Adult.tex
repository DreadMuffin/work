...
\title{4\_2\_PET\_AC\_WB\_FDG\_HER3.Adult}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 50\item kV: 120\item CARE Dose4D: On\item CTDlvol: 3.64mGy\item Scan time: 32.530 s\item Delay: 2.000 s\item Slice: 2 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 50\item Eff. mAs: 50\item kV: 120\item Scan time: 32.530 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 2 mm\item Pitch: 0.80\item Direction: Craniocaudal
\subsection{Recon}
...
\item Inj. Dose: 1 
\item Inj. date (date/month - year): 24/05 - 2012
\item Inj. time: 16:14:43
