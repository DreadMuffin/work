...
\title{4\_7\_PET\_CT\_WB\_FDG\_RT\_MAZ.Adult}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 225\item kV: 120\item CARE Dose4D: On\item CTDlvol: 16.38mGy\item Scan time: 32.530 s\item Delay: 2.000 s\item Slice: 2 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 225\item Eff. mAs: 225\item kV: 120\item Scan time: 32.530 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 2 mm\item Pitch: 0.80\item Direction: Craniocaudal
\subsection{Recon}
...
\item Inj. Dose: 2 
\item Inj. date (date/month - year): 19/01 - 2011
\item Inj. time: 15:32:30
