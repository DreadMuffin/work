...
\title{TUMOR\_HYPOXI\_HUND\_DAG\_4.MlAdult}
...
\item Isotope: Cu-64
\item Pharm.: 
\item Inj. Dose: 0 MegaBequerels
\item Inj. date (date/month - year): 22/04 - 2008
\item Inj. time: 12:03:00
...
\subsubsection{Recon 1}
\item Series description: PET TUMOR Corrected 180 min
...
\subsubsection{Recon 2}
\item Series description: PET TUMOR Uncorrected 180 min
\item Recon range (bed): ups..
