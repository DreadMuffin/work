...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 40\item kV: 38\item CARE Dose4D: Off\item CTDlvol: 2.70069mGy\item Scan time: 0.8000000 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 40 grader
\subsection{Scan}
\item Quality ref. mAs: 50\item Eff. mAs: 40\item kV: 120\item Scan time: 38.240 s\item Rotation time: 0.500 s\item Delay: 4.000 s\item Slice: 0.6 mm\item Pitch: 0.8000000\item Direction: Caudocranial
\subsection{Recon}
...
\item No. of beds: 11
\item Scan duration/bed: 120 PtSecond
\subsection{Scan}
\item Autoload: On
