...
\title{6\_Hjerne\_PiB\_PET\_LM\_5.MlAdult}
...
\section{CT Brain}
\subsection{Routine}
\item Eff. mAs: 40\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 5.504mGy\item Scan time: 9.310 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 40 grader
\subsection{Scan}
...
\item No. of beds: 1
\item Scan duration/bed: 30 Minutes
\subsection{Scan}
\item Autoload: On
