...
\title{Hjerne\_PiB\_PET\_LM\_5.MlAdult}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 40\item kV: 9\item CARE Dose4D: Off\item CTDlvol: 5.504mGy\item Scan time: 1.0000000 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 40 grader
\subsection{Scan}
\item Quality ref. mAs: 380\item Eff. mAs: 40\item kV: 120\item Scan time: 9.310 s\item Rotation time: 1.000 s\item Delay: 4.000 s\item Slice: 0.6 mm\item Pitch: 1.0000000\item Direction: Craniocaudal
\subsection{Recon}
...
\item Inj. date (date/month - year): 08/07 - 2009
\item Inj. time: 09:31:00
\item Scan mode: List mode
\item Scan range: Match CT FOV
\item No. of beds: 1
\item Scan duration/bed: 30 PtMinute
\subsection{Scan}
\item Autoload: On
