...
\title{6\_PROJ\_Dotatoc\_PET\_5.MlAdult}
...
\subsection{Routine}
\item Eff. mAs: 40\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 2.70069mGy\item Scan time: 18.670 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 40 grader
\subsection{Scan}
