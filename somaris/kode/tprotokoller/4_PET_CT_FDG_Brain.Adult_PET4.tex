...
\section{CT Brain}
\subsection{Routine}
\item Eff. mAs: 380\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 64.9045mGy\item Scan time: 69.697 s\item Delay: 2.000 s\item Slice: 2 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 380\item Eff. mAs: 380\item kV: 120\item Scan time: 69.697 s\item Rotation time: 1.000 s\item Delay: 2.000 s\item Slice: 2 mm\item Pitch: 0.55\item Direction: Craniocaudal\subsection{Recons}
