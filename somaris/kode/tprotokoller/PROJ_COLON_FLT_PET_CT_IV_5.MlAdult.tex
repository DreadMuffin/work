...
\title{6\_PROJ\_COLON\_FLT\_PET\_CT\_IV\_5.MlAdult}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 225\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 15.1475mGy\item Scan time: 14.840 s\item Delay: 60.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 225 grader
\subsection{Scan}
