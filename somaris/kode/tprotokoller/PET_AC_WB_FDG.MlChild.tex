...
\title{6\_PET\_AC\_WB\_FDG.MlChild}
...
\subsection{Scan}\item mA: 50\item kV: 80\item Delay: 4s\item Topogram length: 270 mm\item Direction: Craniocaudal\item Tube position: Top\item API: None\item Kernel: 20s standar\item Window: Topogram Body
\section{CT lavdosis}
\subsection{Routine}
\item Eff. mAs: 30\item kV: 80\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 0.540268mGy\item Scan time: 11.000 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 30 grader
\subsection{Scan}
