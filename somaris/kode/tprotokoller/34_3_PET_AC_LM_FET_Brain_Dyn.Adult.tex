...
\title{4\_3\_PET\_AC\_LM\_FET\_Brain\_Dyn.Adult}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 30\item kV: 120\item CARE Dose4D: Off\item CTDlvol: 5.124mGy\item Scan time: 26.200 s\item Delay: 2.000 s\item Slice: 3 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 350\item Eff. mAs: 30\item kV: 120\item Scan time: 26.200 s\item Rotation time: 1.000 s\item Delay: 2.000 s\item Slice: 3 mm\item Pitch: 1.50\item Direction: Craniocaudal
\subsection{Recon}
