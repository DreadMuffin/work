...
\title{PET\_AC\_WB.MlChild\_PET6}
...
\section{CT Lavdosis}
\subsection{Routine}
\item Eff. mAs: 30\item kV: 80\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 0.54mGy\item Scan time: 6.830 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 50\item Eff. mAs: 30\item kV: 80\item Scan time: 6.830 s\item Rotation time: 0.500 s\item Delay: 4.000 s\item Slice: 3.00 mm\item Pitch: 1.5000000\item Direction: Craniocaudal\subsection{Recons}
