...
\title{PETCT\_WholeBody\_Ped.MlChild}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 55\item kV: 7\item CARE Dose4D: On\item CTDlvol: 3.70884mGy\item Scan time: 1.4000000 s\item Delay: 4.000 s\item Slice: 5.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 55 grader
\subsection{Scan}
\item Quality ref. mAs: 55\item Eff. mAs: 55\item kV: 120\item Scan time: 7.280 s\item Rotation time: 0.500 s\item Delay: 4.000 s\item Slice: 0.6 mm\item Pitch: 1.4000000\item Direction: Craniocaudal
\subsection{Recon}
