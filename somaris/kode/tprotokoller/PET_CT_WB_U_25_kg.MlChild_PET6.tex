...
\title{PET\_CT\_WB\_U\_25\_kg.MlChild\_PET6}
...
\subsection{Scan}\item mA: 50\item kV: 80\item Delay: 4s\item Topogram length: 0 mm\item Direction: Craniocaudal\item Tube position: Top\item API: None\item Kernel: 80s shar\item Window: Topogram Body
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 35\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 2.359mGy\item Scan time: 6.830 s\item Delay: 20.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 50\item Eff. mAs: 35\item kV: 120\item Scan time: 6.830 s\item Rotation time: 0.500 s\item Delay: 20.000 s\item Slice: 3.00 mm\item Pitch: 1.5000000\item Direction: Craniocaudal\subsection{Recons}
