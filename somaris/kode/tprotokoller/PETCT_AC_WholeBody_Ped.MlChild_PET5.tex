...
\title{PETCT\_AC\_WholeBody\_Ped.MlChild\_PET5}
...
\subsection{Scan}\item mA: 50\item kV: 80\item Delay: 4s\item Topogram length: 768 mm\item Direction: Craniocaudal\item Tube position: Top\item API: None\item Kernel: 80s shar\item Window: Topogram Body
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 25\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 1.685mGy\item Scan time: 6.830 s\item Delay: 4.000 s\item Slice: 5.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
