...
\title{PETCT\_AC\_WholeBody\_Test.Adult\_PET4}
...
\subsection{Routine}
\item Eff. mAs: 225\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 16.38mGy\item Scan time: 7.290 s\item Delay: 60.000 s\item Slice: 3 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 225\item Eff. mAs: 225\item kV: 120\item Scan time: 7.290 s\item Rotation time: 0.500 s\item Delay: 60.000 s\item Slice: 3 mm\item Pitch: 1.40\item Direction: Craniocaudal\subsection{Recons}
