...
\title{4\_PETCT\_AC\_Brain\_Ped.Child}
...
\subsection{Scan}
\item mA: 50\item kV: 80\item Delay: 4s\item Topogram length: 256 mm\item Direction: Craniocaudal\item Tube position: Lateral\item API: ""\item Kernel: T20s\item Window: Topogra
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 85\item kV: 80\item CARE Dose4D: Off\item CTDlvol: 4.4795mGy\item Scan time: 20.050 s\item Delay: 2.000 s\item Slice: 3 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 85\item Eff. mAs: 85\item kV: 80\item Scan time: 20.050 s\item Rotation time: 1.000 s\item Delay: 2.000 s\item Slice: 3 mm\item Pitch: 1.00\item Direction: Craniocaudal
\subsection{Recon}
