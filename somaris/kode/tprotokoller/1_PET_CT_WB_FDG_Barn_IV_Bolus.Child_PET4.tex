...
\title{1\_PET\_CT\_WB\_FDG\_Barn\_IV\_Bolus.Child\_PET4}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 85\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 6.188mGy\item Scan time: 11.070 s\item Delay: 6.000 s\item Slice: 2 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 85\item Eff. mAs: 85\item kV: 120\item Scan time: 11.070 s\item Rotation time: 0.500 s\item Delay: 6.000 s\item Slice: 2 mm\item Pitch: 1.20\item Direction: Craniocaudal\subsection{Recons}
...
\item Isotope: F-18
\item Pharm.: FDG
\item Inj. Dose: 87000000.000000 Bequerels
\item Inj. date (date/month - year): 21/07 - 2011
\item Inj. time: 08:35:13
