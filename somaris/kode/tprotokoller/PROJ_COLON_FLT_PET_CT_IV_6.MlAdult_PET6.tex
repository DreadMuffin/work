...
\title{PROJ\_COLON\_FLT\_PET\_CT\_IV\_6.MlAdult\_PET6}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 225\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 15.1475mGy\item Scan time: 12.680 s\item Delay: 75.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 225\item Eff. mAs: 225\item kV: 120\item Scan time: 12.680 s\item Rotation time: 0.500 s\item Delay: 75.000 s\item Slice: 3.00 mm\item Pitch: 1.2000000\item Direction: Craniocaudal\subsection{Recons}
...
\subsubsection{Recon 2}
\item Series description: PET FLT True X 2 mm
\item Recon range (bed): -1 to -1
\item Output image type: Corrected
