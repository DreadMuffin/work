...
\title{8\_PET\_Cardiac\_LM\_Rb82.MlAdult\_PET6}
...
\item Series description: AC CT NH3
\item Slice: 3.00
...
\item Inj. Dose: 1100 MegaBequerels
\item Scan mode: List mode
\item Scan range: Match CT FOV
\item No. of beds: 1
\item Scan duration/bed: 7 Minutes
\subsection{Scan}
\item Autoload: On
...
\subsection{Recons}
\subsubsection{Recon 1}
\item Series description: PET  Cardiac Rb82 Rest
...
\section{Pause}
\section{PET StressLM }\subsection{Routine}
\item Isotope: Rb-82
\item Pharm.: Liquid Solution
\item Inj. Dose: 1100 MegaBequerels
\item Scan mode: List mode
...
\subsection{Recons}
\subsubsection{Recon 1}
\item Series description: PET  Cardiac Rb82 Stress
\item Recon range (bed): -1 to -1
\item Output image type: NoRecon
\item Recon method: Iterative
\item Iterations: 4
