...
\subsection{Routine}
\item Eff. mAs: 32\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 5.69736mGy\item Scan time: 17.652 s\item Delay: 2.000 s\item Slice: 3 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 350\item Eff. mAs: 32\item kV: 120\item Scan time: 17.652 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 3 mm\item Pitch: 0.55\item Direction: Caudocranial\subsection{Recons}
