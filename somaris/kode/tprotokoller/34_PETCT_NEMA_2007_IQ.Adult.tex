...
\title{4\_PETCT\_NEMA\_2007\_IQ.Adult}
...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 50\item kV: 120\item CARE Dose4D: Off\item CTDlvol: 3.64mGy\item Scan time: 8.050 s\item Delay: 2.000 s\item Slice: 5 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 120\item Eff. mAs: 50\item kV: 120\item Scan time: 8.050 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 5 mm\item Pitch: 0.80\item Direction: Craniocaudal
\subsection{Recon}
