...
\subsection{Scan}
\item mA: 35\item kV: 120\item Delay: 4s\item Topogram length: 512 mm\item Direction: Craniocaudal\item Tube position: Top\item API: None\item Kernel: T20s standard\item Window: Topogram Body
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 150\item kV: 16\item CARE Dose4D: On\item CTDlvol: 11.4602mGy\item Scan time: 0.8000000 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 150 grader
\subsection{Scan}
\item Quality ref. mAs: 150\item Eff. mAs: 150\item kV: 120\item Scan time: 16.010 s\item Rotation time: 1.000 s\item Delay: 4.000 s\item Slice: 0.6 mm\item Pitch: 0.8000000\item Direction: Craniocaudal
\subsection{Recon}
