...
\section{DynMulti}
\subsection{Routine}
\item Eff. mAs: 100\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDose\item CTDlvol: 606.6mGy\item Scan time: 90.000 s\item Delay: 4.000 s\item Slice: 7.20 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 100\item Eff. mAs: 100\item kV: 120\item Scan time: 90.000 s\item Rotation time: 1.000 s\item Delay: 4.000 s\item Slice: 7.20 mm\item Pitch: 1.0000000\item Direction: Craniocaudal\subsection{Recons}
