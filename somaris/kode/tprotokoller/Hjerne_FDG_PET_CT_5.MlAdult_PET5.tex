...
\title{Hjerne\_FDG\_PET\_CT\_5.MlAdult\_PET5}
...
\section{Diagn.CT Brain}
\subsection{Routine}
\item Eff. mAs: 380\item kV: 120\item CARE Dose4D: Off\item CareDoseType: CareDoseAEC\item CTDlvol: 52.2276mGy\item Scan time: 8.010 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 380\item Eff. mAs: 380\item kV: 120\item Scan time: 8.010 s\item Rotation time: 1.000 s\item Delay: 4.000 s\item Slice: 3.00 mm\item Pitch: 1.2000000\item Direction: Caudocranial\subsection{Recons}
...
\item Series description: Diagn. CT Brain Suppl.zoom
\item Slice: 3.00
...
\item Isotope: F-18
\item Pharm.: FDG
\item Inj. Dose: 227 MegaBequerels
\item Inj. date (date/month - year): 07/07 - 2011
\item Inj. time: 14:30:51
...
\subsubsection{Recon 2}
\item Series description: PET Brain neurostat
\item Recon range (bed): Automatic/All/dunno
\item Output image type: Corrected
