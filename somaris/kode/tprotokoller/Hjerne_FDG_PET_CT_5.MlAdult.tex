...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 380\item kV: 8\item CARE Dose4D: Off\item CTDlvol: 52.2276mGy\item Scan time: 1.2000000 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 380 grader
\subsection{Scan}
\item Quality ref. mAs: 380\item Eff. mAs: 380\item kV: 120\item Scan time: 8.010 s\item Rotation time: 1.000 s\item Delay: 4.000 s\item Slice: 0.6 mm\item Pitch: 1.2000000\item Direction: Craniocaudal
\subsection{Recon}
