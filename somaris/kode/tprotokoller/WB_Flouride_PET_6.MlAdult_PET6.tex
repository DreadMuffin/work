...
\title{WB\_Flouride\_PET\_6.MlAdult\_PET6}
...
\subsection{Routine}
\item mA: 35\item kV: 120\item Topogram length: 480 mm\item Tube position: Top
\subsection{Scan}\item mA: 35\item kV: 120\item Delay: 4s\item Topogram length: 480 mm\item Direction: Caudocranial\item Tube position: Top\item API: None\item Kernel: 80s shar\item Window: Topogram Body
\section{Lavdos Knogle }
\subsection{Routine}
\item Eff. mAs: 40\item kV: 120\item CARE Dose4D: On\item CareDoseType: CareDoseAEC\item CTDlvol: 2.69288mGy\item Scan time: 12.680 s\item Delay: 4.000 s\item Slice: 3.00 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 40\item Eff. mAs: 40\item kV: 120\item Scan time: 12.680 s\item Rotation time: 0.500 s\item Delay: 4.000 s\item Slice: 3.00 mm\item Pitch: 1.2000000\item Direction: Craniocaudal\subsection{Recons}
...
\item Series description: Lavdos Knogle 3.0 B30f
\item Slice: 3.00
...
\subsubsection{Recon 2}
\item Series description: PET Flouride WB True X 2 mm
\item Recon range (bed): -1 to -1
\item Output image type: Corrected
