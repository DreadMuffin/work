...
\title{TEST\_WB\_FDG\_PET\_CT\_IV\_6.MlAdult\_PET6}
...
\subsection{Scan}\item mA: 35\item kV: 120\item Delay: 4s\item Topogram length: 0 mm\item Direction: Craniocaudal\item Tube position: Top\item API: API 6\item Kernel: 80s shar\item Window: Topogram Body
\section{CT WB}
\subsection{Routine}
