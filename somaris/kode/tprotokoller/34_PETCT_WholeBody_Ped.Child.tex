...
\title{4\_PETCT\_WholeBody\_Ped.Child}
...
\subsection{Scan}
\item mA: 35\item kV: 120\item Delay: 4s\item Topogram length: 768 mm\item Direction: Craniocaudal\item Tube position: Top\item API: ""\item Kernel: T80s\item Window: Topogra
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 65\item kV: 120\item CARE Dose4D: On\item CTDlvol: 4.732mGy\item Scan time: 9.580 s\item Delay: 2.000 s\item Slice: 5 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 65\item Eff. mAs: 65\item kV: 120\item Scan time: 9.580 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 5 mm\item Pitch: 1.40\item Direction: Craniocaudal
\subsection{Recon}
