...
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 120\item kV: 120\item CARE Dose4D: On\item CTDlvol: 9.12mGy\item Scan time: 7.250 s\item Delay: 2.000 s\item Slice: 5 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 120\item Eff. mAs: 120\item kV: 120\item Scan time: 7.250 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 5 mm\item Pitch: 1.40\item Direction: Craniocaudal
\subsection{Recon}
