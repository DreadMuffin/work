...
\title{4\_4\_PET\_CT\_WB\_FDG\_Terapi\_Barn.Child}
...
\section{Topogram}
\subsection{Routine}
 \begin{itemize}\item mA: 30\item kV: 120\item Topogram length: 768 mm\item Tube position: Bottom
\subsection{Scan}
\item mA: 30\item kV: 120\item Delay: 4s\item Topogram length: 768 mm\item Direction: Craniocaudal\item Tube position: Bottom\item API: ""\item Kernel: T80s\item Window: Topogra
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 65\item kV: 120\item CARE Dose4D: On\item CTDlvol: 4.732mGy\item Scan time: 11.070 s\item Delay: 6.000 s\item Slice: 2 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 65\item Eff. mAs: 65\item kV: 120\item Scan time: 11.070 s\item Rotation time: 0.500 s\item Delay: 6.000 s\item Slice: 2 mm\item Pitch: 1.20\item Direction: Craniocaudal
\subsection{Recon}
