...
\title{4\_PETCT\_AC\_WholeBody\_Test.Adult}
...
\subsection{Scan}
\item mA: 35\item kV: 120\item Delay: 4s\item Topogram length: 1024 mm\item Direction: Craniocaudal\item Tube position: Top\item API: ""\item Kernel: T80s\item Window: Topogra
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 225\item kV: 120\item CARE Dose4D: On\item CTDlvol: 16.38mGy\item Scan time: 7.290 s\item Delay: 60.000 s\item Slice: 3 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 225\item Eff. mAs: 225\item kV: 120\item Scan time: 7.290 s\item Rotation time: 0.500 s\item Delay: 60.000 s\item Slice: 3 mm\item Pitch: 1.40\item Direction: Craniocaudal
\subsection{Recon}
...
\item Series description: CT WB 3.0 cor B30f
\item Slice: 3
\item Kernel: "B30f"
\item Window: "Abdomen"
\item Extended FoV: false
...
\item Series description: CT WB 3.0 sag B30f
\item Slice: 3
\item Kernel: "B30f"
\item Window: "Abdomen"
\item Extended FoV: false
...
\item Inj. Dose: 3 
\item Inj. date (date/month - year): 13/09 - 2010
\item Inj. time: 15:09:14
...
\subsubsection{Recon 1}
\item Series description: PET WB Corrected HD
...
\subsubsection{Recon 2}
\item Series description: PET WB Corr TrueX+TOF
\item Recon range (bed): ups..
\item Output image type: Corrected
