...
\subsection{Scan}
\item mA: 50\item kV: 80\item Delay: 4s\item Topogram length: 768 mm\item Direction: Craniocaudal\item Tube position: Top\item API: ""\item Kernel: T80s\item Window: Topogra
\section{CT WB}
\subsection{Routine}
\item Eff. mAs: 25\item kV: 80\item CARE Dose4D: Off\item CTDlvol: 0.5125mGy\item Scan time: 9.580 s\item Delay: 2.000 s\item Slice: 5 mm\item No. of images: Samme som i foerste recon, slet?(y/n)\item Tilt: 0.0 grader
\subsection{Scan}
\item Quality ref. mAs: 65\item Eff. mAs: 25\item kV: 80\item Scan time: 9.580 s\item Rotation time: 0.500 s\item Delay: 2.000 s\item Slice: 5 mm\item Pitch: 1.40\item Direction: Craniocaudal
\subsection{Recon}
