...
cur.execute("create table Protocols (Name varchar(200),PETscanner " +
        "char(10),Bodysize char(20),Lenght int,Date datetime,PRIMARY " +
        "KEY (Name,PETscanner));")

cur.execute("create table Topograms (Partof varchar(200), PETscanner char(10)" +
        ...
        "(Partof,PETscanner,Modenr))")

cur.execute("create table CT (PartOf varchar(200),PETscanner char(10), Modenr" +
        ...
        ",Primary Key (Partof,PETscanner,Modenr))")

cur.execute("create table CTrecon (Partof varchar(200),PETscanner char(10)," +
        ...
        "ReconIncrement int,No_of_images int,Primary key (Partof,PETscanner," + 
        "Modenr,Reconnumber))")

cur.execute("create table Pause (Partof varchar(200),PETscanner char(10)," +
        "Modenr int,Primary key (Partof,PETscanner,Modenr))")

cur.execute("create table PET (Partof varchar(200),PETscanner char(10)," +
        "Modenr int,Recons int, Name varchar(20), Isotope varchar(20)," + 
        "Pharm varchar(20),Injdose varchar(30),Injdate varchar(20),Injtime " +
        "varchar(15),Scanmode varchar(15)," +
        "Scanrange varchar(20),Numberofbeds int,Scanduration varchar(22)," +
        ...
        "ULD int,Primary key(Partof,PETscanner,Modenr))")

cur.execute("create table PETrecon (Partof varchar(200),PETscanner char(10)," +
        ...
        "Saveintermediatedata varchar(10),Primary key(Partof,PETscanner," +
        "Modenr,Reconnumber))")
