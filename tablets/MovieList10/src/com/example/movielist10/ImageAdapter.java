...
public class ImageAdapter extends BaseAdapter {
	...
	private String[] mTextsIds = { "Min første balletfilm",
			"Eventyret om den vidunderlige kartoffel",
			"Danske filmperler for børn", "Ponyo", "Timmy-Tid", "Ninjaturtles",
			"Animal Agents" };

	// references to our images
	private Integer[] mThumbIds = { R.drawable.ballet, R.drawable.kartoffel,
			R.drawable.mis, R.drawable.ponyo, R.drawable.timmy,
			R.drawable.turtles, R.drawable.animal };
