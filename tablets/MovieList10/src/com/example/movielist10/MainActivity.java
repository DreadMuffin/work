package com.example.movielist10;

import java.io.File;
import java.util.Arrays;
import java.util.List;

import com.example.movielist10.R;
...
public class MainActivity extends Activity {
	...
	private List<String> film = Arrays.asList("MFBC.Title3.mp4",
			...
			"PONYO.Title1.mp4","TIMMY_TIME.Title9.mp4","TURTLESDVD3_BUILD.Title1.mp4","Phineas_and_Ferb_Animal_Agents_N.Title18.mp4");
