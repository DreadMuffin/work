package com.example.applist12;

import java.io.File;
import java.util.Arrays;
import java.util.List;

import com.example.applist12.R;
...
public class MainActivity extends Activity {
	...
	private List<String> film = Arrays.asList("DK_KARTOFFEL.Title1.mp4",
			"DVD_FILMPERLER.Title1.mp4", "PONYO.Title1.mp4",
			"TIMMY_TIME.Title9.mp4", "TURTLESDVD3_BUILD.Title1.mp4",
