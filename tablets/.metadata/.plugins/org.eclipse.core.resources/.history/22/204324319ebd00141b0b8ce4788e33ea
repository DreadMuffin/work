	...
	private void initiatePopupWindow(int i) {
		try {
			...
			case 2:
				...
				button_1 = (Button) layout2.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 3:
				...
				button_1 = (Button) layout3.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 4:
				...
				button_1 = (Button) layout4.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 5:
				...
				button_1 = (Button) layout5.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 6:
				...
				button_1 = (Button) layout6.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 7:
				...
				button_1 = (Button) layout7.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 8:
				...
				button_1 = (Button) layout8.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 9:
				...
				button_1 = (Button) layout9.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 10:
				...
				button_1 = (Button) layout10.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 11:
				...
				button_1 = (Button) layout11.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			...
			case 12:
				...
				button_1 = (Button) layout12.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			case 13:
				i = 13;
				...
				button_1 = (Button) layout13.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			...
			case 14:
				...
				button_1 = (Button) layout14.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			...
			case 15:
				...
				button_1 = (Button) layout15.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
			...
			case 16:
				...
				button_1 = (Button) layout16.findViewById(R.id.btn_close_popup);
				button_1.setOnClickListener(cancel_button_click_listener);
				break;
