...
public class MainActivity extends Activity {
	...
	private List<String> film = Arrays.asList("MFBC.Title3.mp4",
			"DVDVOLUME.Title1.mp4", "PEPPA2_3.Title82.mp4",
			"DK_KARTOFFEL.Title1.mp4", "DVD_FILMPERLER.Title1.mp4",
			"Morten Skildpadde.mp4", "PETTSON1_SCN.Title2.mp4",
			"MW60EZM1.Title1.mp4", "PONYO.Title1.mp4", "TIMMY_TIME.Title9.mp4",
			"TURTLESDVD3_BUILD.Title1.mp4",
			"Phineas_and_Ferb_Animal_Agents_N.Title18.mp4");
