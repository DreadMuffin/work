package com.example.movielist7;

import java.util.ArrayList;

import com.example.movielist7.R;
...
public class ImageAdapter extends BaseAdapter {
	...
	private String[] mTextsIds = { "Min første balletfilm", "Cirkeline",
			"Gurligris", "Eventyret om den vidunderlige kartoffel",
			"Danske filmperler for børn", "Morten Skildpadde",
			"Pedersen og Findus", "Peter Plys", "Ponyo", "Timmy-Tid",
			"Ninjaturtles", "Animal Agents" };

	// references to our images
	private Integer[] mThumbIds = { R.drawable.ballet, R.drawable.cirkeline,
			R.drawable.gurligris, R.drawable.kartoffel, R.drawable.mis,
			R.drawable.morten, R.drawable.pedersen, R.drawable.plys,
