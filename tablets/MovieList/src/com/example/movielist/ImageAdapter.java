...
public class ImageAdapter extends BaseAdapter {
	...
	private String[] mTextsIds = { "Min første balletfilm", "Bamses Billedbog",
			"Byggemand Bob", "Cirkeline", "Gurligris",
			"Eventyret om den vidunderlige kartoffel", "Lillefinger",
			"Danske filmperler for børn", "Morten Skildpadde",
			"Pedersen og Findus", "Peter Plys", "Ponyo", "Postmand Per",
	...
	private Integer[] mThumbIds = { R.drawable.ballet, R.drawable.bamse,
			...
			R.drawable.ponyo, R.drawable.postmand_per, R.drawable.teletubbies,
			R.drawable.thomas };
