...
public class MainActivity extends Activity {
	...
	private List<String> film = Arrays.asList("MFBC.Title3.mp4",
			"BAMSE_4.Title1.mp4", "BUILT_TO_BE_WILD_SCN.Title5.mp4",
			"DVDVOLUME.Title1.mp4", "PEPPA2_3.Title82.mp4",
			"DK_KARTOFFEL.Title1.mp4", "LILLEFINGER1_V2.Title1.mp4",
			"DVD_FILMPERLER.Title1.mp4", "Morten Skildpadde.mp4",
			"PETTSON1_SCN.Title2.mp4", "MW60EZM1.Title1.mp4",
			"PONYO.Title1.mp4", "POSTMAN_PAT.Title8.mp4",
			"TT AND THE SNOW.Title2.mp4", "THOMAS.Title7.mp4");
