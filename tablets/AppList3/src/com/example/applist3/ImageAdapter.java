...
public class ImageAdapter extends BaseAdapter {
	...
	private String[] mTextsIds = { "Min første balletfilm", "Bamses Billedbog",
			"Byggemand Bob", "Cirkeline", "Gurligris", "Lillefinger",
			"Danske filmperler for børn", "Morten Skildpadde",
			"Pedersen og Findus", "Peter Plys", "Postmand Per", "Thomas Tog" };

	// references to our images
	private Integer[] mThumbIds = { R.drawable.ballet, R.drawable.bamse,
			R.drawable.bob, R.drawable.cirkeline, R.drawable.gurligris,
			R.drawable.lillefinger, R.drawable.mis, R.drawable.morten,
			R.drawable.pedersen, R.drawable.plys, R.drawable.postmand_per,
			R.drawable.thomas, };
