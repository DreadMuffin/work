package com.example.applist0;

import java.util.ArrayList;

import com.example.applist0.R;
...
public class ImageAdapter extends BaseAdapter {
	...
	private String[] mTextsIds = { "Bamses Billedbog", "Byggemand Bob",
			"Cirkeline", "Danske filmperler for børn", "Peter Plys",
			"Postmand Per", "Teletubbies", "Thomas Tog" };

	// references to our images
	private Integer[] mThumbIds = { R.drawable.bamse, R.drawable.bob,
			R.drawable.cirkeline, R.drawable.mis, R.drawable.plys,
			R.drawable.postmand_per, R.drawable.teletubbies, R.drawable.thomas, };
